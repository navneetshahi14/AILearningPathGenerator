  ...
  return (
    <>
      ...
      >
        ...
        <div className="">
          <ul className="flex lg:flex-row flex-col lg:gap-8 text-3xl lg:text-xl 2xl:text-lg 2xl:gap-12 gap-10">
            ...
            <SignedIn>
              <li className="lg:hover:scale-[1.2] cursor-pointer hover:translate-x-4 duration-75 transition-all ease-in-out">
                <Link href={"/generatePage"}>Generate Path</Link>
              </li>
              <li className="lg:hover:scale-[1.2] cursor-pointer hover:translate-x-4 duration-75 transition-all ease-in-out">
        ...
        <div className="flex gap-3 lg:flex-row flex-col justify-end items-start lg:items-center">
          <SignedIn>
            <Link href={"/profile"}>
              <Cog
                className="cursor-pointer font-extrabold hidden 2xl:flex"
                height={30}
                width={30}
              />
          ...
          <SignedOut>
            <Button
              variant={"default"}
              className="cursor-pointer text-2xl lg:text-lg lg:rounded-full rounded-xl"
            >
              <Link href={"/sign-in"}>Login</Link>
            </Button>
            <Button
              variant={"outline"}
              className="bg-white/50 border-black hover:bg-white cursor-pointer text-2xl lg:text-lg lg:rounded-full rounded-xl"
            >
