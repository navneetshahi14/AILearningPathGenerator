    ...
    return (
        <>
            <div className="h-screen w-full flex flex-col justify-between items-center py-10">
                <h1 className="text-center text-lg lg:text-5xl 2xl:text-[3rem] uppercase mt-5 font-semibold">🚀 Ready to Level Up Your Skills?</h1>
                <h1 className="text-center text-3xl lg:text-6xl 2xl:text-[6rem] uppercase font-light px-10 lg:px-44">Start your SkillRoute journey today with our AI agents.</h1>
